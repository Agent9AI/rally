...
The current release has 74 deterministic automated tests plus that live
...
- Source and reproducible setup: [GITHUB LINK]
...
74 tests. 6/6 live ADK evals at 1.00/1.00. Full unedited agent run included.
