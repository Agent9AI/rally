...
| Demo & production readiness (30%) | Deployed path, live eval gate, bounded costs, polished emails, human stop/steer, reproducible repo | 6/6 eval, 201 tests, live Cloud Run health, complete email thread |
...
- 201 automated tests plus six live ADK eval cases at 1.00/1.00
